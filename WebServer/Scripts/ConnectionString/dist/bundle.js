...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ConnectionStringModels__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Utilities__ = __webpack_require__(6);
...
var connectionStringClient = (function () {
    ...
    connectionStringClient.prototype.load = function (then) {
    ...
    connectionStringClient.prototype.delete = function (conStringId, then) {
        if (then === void 0) { then = function () { }; }
        var _self = this;
        $.ajax({
    ...
    connectionStringClient.prototype.update = function (conString, then) {
        if (then === void 0) { then = function () { }; }
        var _self = this;
        $.ajax({
